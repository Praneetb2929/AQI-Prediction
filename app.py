...
with tab1:
    ...
    if st.button("Predict AQI"):
        ...
        if aqi <= 50:
            ...
            st.warning("Moderate – Breathing discomfort to people with lung disease.")
        elif aqi <= 300:
            st.warning("Poor – Breathing discomfort to most people.")
        elif aqi <= 400:
        ...
        st.write("✔ Keep windows closed during peak pollution")
